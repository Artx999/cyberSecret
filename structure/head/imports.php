...
-->
<!-- Favicon -->
<link rel="icon" type="image/png" href="<?php print $rootPath ?>images/eslglogo_transparrent.png">
<!-- Fonts -->
...
<script src="<?php print $rootPath ?>javascript/script.js" type="text/javascript" defer></script>
<!-- Stylesheets -->
<link type="text/css" rel="stylesheet" href="<?php print $rootPath ?>css/style.css">
<!-- Icons -->
